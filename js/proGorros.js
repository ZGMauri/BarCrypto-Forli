...
const fetchData = () => {
	...
	let productos = {
	  1: { nombre: "Gorro BTC", precio: 8,"img": "../Pages/Img/gorroB.jpg" },
	  2: { nombre: "Gorro ADA", precio: 8,"img": "../Pages/Img/adagorro.jpg" },
	  3: { nombre: "Gorro ETH", precio: 8,"img": "../Pages/Img/ethgorro.jpg" },
	  4: { nombre: "Gorro HODL", precio: 8,"img": "../Pages/Img/hodl.jpg" },
	  5: { nombre: "Gorro CRYPTO", precio: 8,"img": "../Pages/Img/cryptogorro.jpg" },
	  6: { nombre: "Gorro SHIBA", precio: 8,"img": "../Pages/Img/GorroSH.jpg" },
	};
